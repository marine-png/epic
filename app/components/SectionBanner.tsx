  ...
  return (
    <section className="pt-32 pb-20 relative overflow-hidden" style={{ backgroundColor: color }}>
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-white">
        <span className="inline-block text-xs font-semibold uppercase tracking-[0.25em] bg-white/20 px-3 py-1 rounded mb-6">{label}</span>
        ...
        {cta && (
          <a href={cta.href} className="inline-block mt-8 bg-white text-gray-900 font-semibold px-7 py-3 rounded hover:bg-gray-100 transition-colors">{cta.label}</a>
        )}
      </div>
